...
calendario = pd.read_csv("D:\Trabajo 07062019\Personal\España\Master Data Science\TFM\capstone-project-2\capstone-project-r2\data\daily_calendar_with_events.csv", dtype=columna_tipos)
