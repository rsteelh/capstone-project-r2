...
precios = pd.read_csv("C:\RS\España\Master Data Science\TFM\capstone-project-2\capstone-project-r2\capstone-project-r2\data\item_prices.csv", dtype=columna_tipos)
